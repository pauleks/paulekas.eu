...
setInterval(() => {
    let birthday = new Date('2003-11-30'), now = new Date();
    years.value = (Math.abs(now - birthday) / (1000 * 60 * 60 * 24 * 365)).toFixed(8);
}, 100)
</script>
...
.lithuania {
    background: linear-gradient(120deg, #fbea00, #00f821, #ff4a32);
